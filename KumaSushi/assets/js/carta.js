...
function ocultarMakis(){
    ...
    if(ocuMakis.style.display == "grid"){
        ocuMakis.style.display = "flex";
    }
    else{
...
function ocultarPlatos(){
    var ocuPlatos = document.getElementById("wrap-platos");
    if(ocuPlatos.style.display == "grid"){
        ocuPlatos.style.display = "flex";
    }
    else{
